...
const serverSchema = new mongoose.Schema({
    ...
    settings: {
        ...
        moderatorRole: { type: String, default: '' },
        ...
        badwordsPunishment: { type: String, default: 'delete_warn' },
        spamPunishment: { type: String, default: 'delete_warn' },
        linkPunishment: { type: String, default: 'delete_warn' },
        capsPunishment: { type: String, default: 'delete_warn' },
        floodPunishment: { type: String, default: 'delete_warn' },
        ...
        blacklistIgnoredChannels: { type: [String], default: [] },
        blacklistIgnoredRoles: { type: [String], default: [] },
